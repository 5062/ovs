...
void match_set_tcp_seq(struct match *, ovs_be32);
void match_set_tcp_seq_masked(struct match *, ovs_be32 tcp_seq, ovs_be32 mask);
void match_set_tcp_ack(struct match *, ovs_be32);
void match_set_tcp_ack_masked(struct match *, ovs_be32 tcp_ack, ovs_be32 mask);
